...
export class DefaultService {
     ...
     * @throws ApiError
     */
    public deleteStudyV1StudiesStudyIdDelete(data: DeleteStudyV1StudiesStudyIdDeleteData): CancelablePromise<DeleteStudyV1StudiesStudyIdDeleteResponse> {
        return this.httpRequest.request({
            method: 'DELETE',
            url: '/v1/studies/{study_id}',
            path: {
