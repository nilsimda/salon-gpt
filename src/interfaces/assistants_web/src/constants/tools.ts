...
export const TOOL_SEARCH_INTERVIEW_ID = 'search_interview';
...
export const FILE_UPLOAD_TOOLS = [TOOL_SEARCH_INTERVIEW_ID, TOOL_READ_DOCUMENT_ID];
...
export const TOOL_ID_TO_DISPLAY_INFO: { [id: string]: { icon: IconName } } = {
  ...
  [TOOL_SEARCH_INTERVIEW_ID]: { icon: 'search' },
