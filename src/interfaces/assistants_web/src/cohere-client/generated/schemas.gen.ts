...
export const AgentToolMetadataSchema = {
    properties: {
        id: {
            type: 'string',
            title: 'Id'
...
export const AgentToolMetadataPublicSchema = {
    properties: {
        id: {
            type: 'string',
            title: 'Id'
...
export const AgentVisibilitySchema = {
    type: 'string',
    enum: ['private', 'public', 'all'],
    title: 'AgentVisibility'
} as const;

export const Body_batch_upload_file_v1_agents_batch_upload_file_postSchema = {
    properties: {
        files: {
            items: {
                type: 'string',
...
export const Body_batch_upload_file_v1_conversations_batch_upload_file_postSchema = {
    properties: {
        conversation_id: {
            type: 'string',
...
export const ChatResponseEventSchema = {
    properties: {
        event: {
...
export const CohereChatPromptTruncationSchema = {
    type: 'string',
...
export const CohereChatRequestSchema = {
    properties: {
        message: {
            type: 'string',
...
export const ConversationFilePublicSchema = {
    properties: {
        id: {
            type: 'string',
            title: 'Id'
...
export const ConversationWithoutMessagesSchema = {
    properties: {
        id: {
            type: 'string',
            title: 'Id'
...
export const CreateAgentToolMetadataRequestSchema = {
    properties: {
        id: {
            anyOf: [
                {
...
export const CreateSnapshotRequestSchema = {
    properties: {
        conversation_id: {
            type: 'string',
            title: 'Conversation Id'
...
export const CreateSnapshotResponseSchema = {
    properties: {
        snapshot_id: {
            type: 'string',
            title: 'Snapshot Id'
...
export const CreateStudyRequestSchema = {
    properties: {
        name: {
            type: 'string',
            title: 'Name'
...
export const DeleteAgentFileResponseSchema = {
    properties: {},
    type: 'object',
    title: 'DeleteAgentFileResponse'
} as const;

export const DeleteAgentToolMetadataSchema = {
    properties: {},
    type: 'object',
    title: 'DeleteAgentToolMetadata'
} as const;

export const DeleteConversationFileResponseSchema = {
    properties: {},
    type: 'object',
...
export const DeleteSnapshotLinkResponseSchema = {
    properties: {},
    type: 'object',
    title: 'DeleteSnapshotLinkResponse'
} as const;

export const DeleteSnapshotResponseSchema = {
    properties: {},
    type: 'object',
    title: 'DeleteSnapshotResponse'
} as const;

export const DeleteStudySchema = {
    properties: {},
    type: 'object',
    title: 'DeleteStudy'
} as const;

export const DeleteToolAuthSchema = {
    properties: {},
    type: 'object',
...
export const DeploymentWithModelsSchema = {
    properties: {
        id: {
            anyOf: [
                {
...
export const GroupOperationSchema = {
    properties: {
        op: {
            type: 'string',
            title: 'Op'
...
export const ListAuthStrategySchema = {
    properties: {
        strategy: {
            type: 'string',
            title: 'Strategy'
...
export const ListConversationFileSchema = {
    properties: {
        id: {
            type: 'string',
            title: 'Id'
...
export const ListGroupResponseSchema = {
    properties: {
        totalResults: {
            type: 'integer',
            title: 'Totalresults'
...
export const ListUserResponseSchema = {
    properties: {
        totalResults: {
            type: 'integer',
            title: 'Totalresults'
...
export const ManagedToolSchema = {
    properties: {
        name: {
            anyOf: [
                {
...
export const MessageAgentSchema = {
    type: 'string',
    enum: ['USER', 'CHATBOT'],
    title: 'MessageAgent'
} as const;
...
export const ModelSimpleSchema = {
    properties: {
        id: {
            type: 'string',
            title: 'Id'
...
export const NonStreamedChatResponseSchema = {
    properties: {
        response_id: {
            anyOf: [
                {
...
export const SnapshotPublicSchema = {
    properties: {
        conversation_id: {
            type: 'string',
            title: 'Conversation Id'
...
export const SnapshotWithLinksSchema = {
    properties: {
        conversation_id: {
            type: 'string',
            title: 'Conversation Id'
...
export const StreamCitationGenerationSchema = {
    properties: {
        citations: {
            items: {
                '$ref': '#/components/schemas/Citation'
...
export const StreamQueryGenerationSchema = {
    properties: {
        query: {
            type: 'string',
...
export const StreamSearchQueriesGenerationSchema = {
    properties: {
        search_queries: {
            items: {
                '$ref': '#/components/schemas/SearchQuery'
...
export const StreamSearchResultsSchema = {
    properties: {
        search_results: {
            items: {
                type: 'object'
...
export const StreamStartSchema = {
    properties: {
        generation_id: {
            anyOf: [
                {
...
export const StreamTextGenerationSchema = {
    properties: {
        text: {
            type: 'string',
            title: 'Contents of the chat message.'
...
export const StreamToolCallsChunkSchema = {
    properties: {
        tool_call_delta: {
            anyOf: [
                {
...
export const StreamToolCallsGenerationSchema = {
    properties: {
...
export const StreamToolInputSchema = {
    properties: {
        input_type: {
...
export const StreamToolResultSchema = {
    properties: {
        result: {
            title: 'Result'
        },
...
export const ToolInputTypeSchema = {
    type: 'string',
    enum: ['QUERY', 'CODE'],
    title: 'ToolInputType',
...
export const UpdateAgentToolMetadataRequestSchema = {
    properties: {
        id: {
            anyOf: [
                {
...
export const UpdateDeploymentEnvSchema = {
    properties: {
        env_vars: {
            additionalProperties: {
                type: 'string'
...
export const UpdateStudyRequestSchema = {
    properties: {
        name: {
            anyOf: [
                {
...
export const UploadAgentFileResponseSchema = {
    properties: {
        id: {
            type: 'string',
            title: 'Id'
...
export const UploadConversationFileResponseSchema = {
    properties: {
        id: {
            type: 'string',
            title: 'Id'
...
export const backend__schemas__scim__CreateUserSchema = {
    properties: {
        userName: {
            anyOf: [
                {
...
export const backend__schemas__scim__UpdateUserSchema = {
    properties: {
        userName: {
            anyOf: [
                {
...
export const backend__schemas__scim__UserSchema = {
    properties: {
        userName: {
            anyOf: [
                {
...
export const backend__schemas__user__CreateUserSchema = {
    properties: {
        password: {
            anyOf: [
                {
...
export const backend__schemas__user__UpdateUserSchema = {
    properties: {
        password: {
            anyOf: [
                {
...
export const backend__schemas__user__UserSchema = {
    properties: {
        fullname: {
            type: 'string',
            title: 'Fullname'
